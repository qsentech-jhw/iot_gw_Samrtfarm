...
class ModbusRTUMaster {
  public:
    ...
    void begin_readHoldingRegisters(uint8_t id, uint16_t startAddress, uint16_t quantity);
    bool readHoldingRegisters_end(uint8_t id, uint16_t *buf, uint16_t quantity);
